    ...
    if (isLoggedIn) {
        profileDropdown.innerHTML = `
            <div class="profile-btn" id="profileBtn">
                <img src="https://ui-avatars.com/api/?name=${encodeURIComponent(username)}&background=2A4D69&color=fff" alt="Profile">
            </div>
        ...
        profileDropdown.innerHTML = `<a href="login.html" class="btn-primary">Login</a>`;
    }
}
